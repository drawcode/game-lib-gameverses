	...
	public class GameNetworkingPhoton : MonoBehaviour, IPhotonPeerListener  {
		...
		*/
	    ...
	    IEnumerator TestConnection() {
			...
			//MessengerString<bool, UnityEngine.ConnectionTesterStatus, bool, bool, string>.Broadcast(NetworkMessages.NetworkNatTestComplete, testedUseNat, connectionTestResult, probingPublicIP, hasTestedNAT, testMessage);
