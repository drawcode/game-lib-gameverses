...
namespace Gameverses {
	...
	*/
	...
	public class GameversesContents {
		...
		void HandleDownloadAssetBundleCallback(ServiceUtil.ResponseObject response) {
		...
		void HandleDownloadableContentInfoCallback(ServiceUtil.ResponseObject response) {
		...
		void HandleDownloadableContentSetSyncCallback(ServiceUtil.ResponseObject response) {
		...
		void HandleDownloadableFileCallback(ServiceUtil.ResponseObject response) {
