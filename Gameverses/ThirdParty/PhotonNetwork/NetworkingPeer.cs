...
namespace Gameverses.Photon {
    ...
    internal class NetworkingPeer : LoadbalancingPeer, IPhotonPeerListener {
        ...
        public NetworkingPeer(IPhotonPeerListener listener, string playername, ConnectionProtocol connectionProtocol)
            ...
            this.State = global::Gameverses.Photon.PeerState.PeerCreated;
        }

        #region Operations and Connection Methods

        public override bool Connect(string serverAddress, string appID, byte nodeId) {
            if (PhotonNetwork.connectionStateDetailed == global::Gameverses.Photon.PeerState.Disconnecting) {
            ...
            this.State = connecting ? global::Gameverses.Photon.PeerState.Connecting : global::Gameverses.Photon.PeerState.Disconnected;
        ...
        public override void Disconnect() {
            ...
            base.Disconnect();
            this.State = global::Gameverses.Photon.PeerState.Disconnecting;
        ...
        private void DisconnectFromMaster() {
            base.Disconnect();
            this.State = global::Gameverses.Photon.PeerState.DisconnectingFromMasterserver;
            LeftLobbyCleanup();
        }
        ...
        private void DisconnectFromGameServer() {
            base.Disconnect();
            this.State = global::Gameverses.Photon.PeerState.DisconnectingFromGameserver;
            this.LeftRoomCleanup();
        }
        ...
        private void SendPlayerName() {
            if (this.State == global::Gameverses.Photon.PeerState.Joining) {
        ...
        private void GameEnteredOnGameServer(OperationResponse operationResponse) {
            ...
            this.State = global::Gameverses.Photon.PeerState.Joined;
        ...
        public virtual bool OpLeave() {
            if (this.State != global::Gameverses.Photon.PeerState.Joined) {
        ...
        public void OnOperationResponse(OperationResponse operationResponse) {
            if (PhotonNetwork.networkingPeer.State == global::Gameverses.Photon.PeerState.Disconnecting) {
                if (this.DebugOut >= DebugLevel.INFO) {
            ...
            switch (operationResponse.OperationCode) {
                case OperationCode.Authenticate: {
                        ...
                        if (operationResponse.ReturnCode != 0) {
                            ...
                            if (this.State == global::Gameverses.Photon.PeerState.Connected || this.State == global::Gameverses.Photon.PeerState.ConnectedComingFromGameserver) {
                                if (operationResponse.Parameters.ContainsKey(ParameterCode.Position)) {
                                    ...
                                    if (this.mQueuePosition > 0) {
                                        ...
                                        if (this.State == global::Gameverses.Photon.PeerState.ConnectedComingFromGameserver) {
                                            this.State = global::Gameverses.Photon.PeerState.QueuedComingFromGameserver;
                                        }
                                        else {
                                            this.State = global::Gameverses.Photon.PeerState.Queued;
                                        }
                                ...
                                if (PhotonNetwork.autoJoinLobby) {
                                    this.OpJoinLobby();
                                    this.State = global::Gameverses.Photon.PeerState.Authenticated;
                                }
                                else {
                                    this.State = global::Gameverses.Photon.PeerState.ConnectedToMaster;
                                    NetworkingPeer.SendMonoMessage(PhotonNetworkingMessage.OnConnectedToMaster);
                                }
                            }
                            else if (this.State == global::Gameverses.Photon.PeerState.ConnectedToGameserver) {
                                this.State = global::Gameverses.Photon.PeerState.Joining;
                ...
                case OperationCode.JoinLobby:
                    this.State = global::Gameverses.Photon.PeerState.JoinedLobby;
        ...
        public void OnStatusChanged(StatusCode statusCode) {
            ...
            switch (statusCode) {
                case StatusCode.Connect:
                    if (this.State == global::Gameverses.Photon.PeerState.ConnectingToGameserver) {
                        if (this.DebugOut >= DebugLevel.ALL) {
                            this.DebugReturn(DebugLevel.ALL, "Connected to gameserver.");
                        }
                        this.State = global::Gameverses.Photon.PeerState.ConnectedToGameserver;
                    }
                    else {
                        if (this.DebugOut >= DebugLevel.ALL) {
                            this.DebugReturn(DebugLevel.ALL, "Connected to masterserver.");
                        }
                        if (this.State == global::Gameverses.Photon.PeerState.Connecting) {
                            SendMonoMessage(PhotonNetworkingMessage.OnConnectedToPhoton);
                            this.State = global::Gameverses.Photon.PeerState.Connected;
                        }
                        else {
                            this.State = global::Gameverses.Photon.PeerState.ConnectedComingFromGameserver;
                        }
                    }
                ...
                case StatusCode.Disconnect:
                    if (this.State == global::Gameverses.Photon.PeerState.DisconnectingFromMasterserver) {
                        if (this.nodeId != 0) {
                            Debug.Log("connecting to game on node " + this.nodeId);
                        }

                        this.Connect(this.mGameserver, this.mAppId, this.nodeId);
                        this.State = global::Gameverses.Photon.PeerState.ConnectingToGameserver;
                    }
                    else if (this.State == global::Gameverses.Photon.PeerState.DisconnectingFromGameserver) {

                        // don't preselect node
                        this.nodeId = 0;
                        this.Connect(this.masterServerAddress, this.mAppId, 0);
                        this.State = global::Gameverses.Photon.PeerState.ConnectingToMasterserver;
                    }
                    else {
                        this.LeftRoomCleanup();
                        this.State = global::Gameverses.Photon.PeerState.PeerCreated;
