...
public static class BaseAppConfigs {
    ...
    */  
    ...
    public static string
        stringSavedPhotoTitleDefault = "template Photo";
    [NonSerialized]
    public static string
        stringTwitterPostMessage = "template! template.com";
    [NonSerialized]
    public static string
        stringTwitterDisabledTitle = "Twitter Disabled";
    [NonSerialized]
    public static string
        stringTwitterDisabledMessage = "Twitter is not configured on this device. Open the Settings App and enter your Twitter username and password to enable this feature.";
    [NonSerialized]
    public static string
        stringFacebookPostMessage = "I viewed some augmented reality in the template App! template.com";
    [NonSerialized]
    public static string
        stringFacebookUploadErrorTitle = "An error occurred.";
    [NonSerialized]
    public static string
        stringFacebookUploadErrorMessage = "The following error occcurred:";
    [NonSerialized]
    public static string
        stringFacebookUploadSuccessTitle = "Success";
    [NonSerialized]
    public static string
        stringFacebookUploadSuccessMessage = "The photo has been uploaded to your facebook photo feed.";
    [NonSerialized]
    public static string
        stringPendingCreatingScreenshot = "Creating screenshot...";
    [NonSerialized]
    public static string
        stringPendingUploadingPost = "Uploading...";
    [NonSerialized]
    public static string
        stringLibraryPhotoSavedTitle = "Photo Saved!";
    [NonSerialized]
    public static string
        stringLibraryPhotoSavedMessage = "Your picture has been saved to your photo album.";
    [NonSerialized]
    public static string
        socialStatisticForFacebook = "points";
